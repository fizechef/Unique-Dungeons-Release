...
public class DesertDungeonJunction extends ADesertDungeonPiece {
    public DesertDungeonJunction(PieceConnection entrance, PieceConnection[] exits, String name, Tuple<DesertDungeonDeco, Tuple<Vec3i, Rotation>>[] deco) {
