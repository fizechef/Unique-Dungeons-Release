...
public class SonicBoomProjectileRenderer extends EntityRenderer<SonicBoomProjectile> {
    ...
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(UniqueDungeons.MOD_ID, "textures/entity/sonic_boom_projectile.png");

    private final AmethystProjectileModel model;

    @Override
    public ResourceLocation getTextureLocation(SonicBoomProjectile pEntity) {
        return TEXTURE_LOCATION;
    }
    @Override
    public void render(SonicBoomProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
